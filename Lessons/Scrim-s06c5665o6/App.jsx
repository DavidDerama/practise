...
export default function App() {
	...
	function handleClick(selectedEmoji) {
		setPassedEmojis([])
		setLikedEmojis(prev => [...prev, selectedEmoji])
		currentEmojis.forEach(emoji => emoji !== selectedEmoji && !likedEmojis.includes(emoji) && setPassedEmojis(prev => [...prev, emoji]))
		console.log(passedEmojis)
		// setPassedEmojis(notLikedEmojis)
	}
