...
*/
    ...
    const text = currentData.text.quoteFontSize
    
    const imageText = currentData.image.quoteFontSize
    console.log(getSmallestFontSize(text, imageText))
    ...
    return (
        <div className="wrapper" style={currentData.image.wrapperStyles}>
            <div className="quote-container" style={currentData.image.containerStyles}>
                <p className="quote" style={getSmallestFontSize(text, imageText)}>
