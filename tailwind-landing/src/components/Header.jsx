...
export const Header = () => {
  return (
    <header class="bg-indigo-700 px-5 py-8 gap-4 border-b-4 border-pink-500">
      <div className="max-w-screen-lg mx-auto relative">
        <section class="flex justify-between text-pink-500">
          <svg
        ...
        <section class="text-white flex flex-col items-start w-4/5">
          <h1 class="text-4xl mt-3 font-medium">Want to learn Tailwind CSS?</h1>
          <h2 class="text-lg font-light mt-2">
            Tailwind is the fastest growing utility-first CSS framework. Let's
            learn it step by step.
          </h2>
          <button class="bg-pink-500 py-1 px-4 rounded-2xl text-base font-semibold mt-9 border-0">
            Enroll Now
          </button>
        </section>
        <section class="w-24 h-24 rounded-full flex justify-center items-center absolute border-4 border-pink-500 right-0 -bottom-20 bg-white">
          <img src={tailwindLogo} class="w-12 h-12" />
        </section>
      </div>
    </header>
  );
