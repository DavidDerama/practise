...
export const Header = () => {
  return (
    <header class="gap-4 border-b-4 border-pink-500 bg-accent px-5 py-8">
      <div className="relative mx-auto max-w-screen-lg">
        ...
        <section class="flex w-4/5 flex-col items-start text-white">
          <h1 class="mt-5 text-5xl font-medium leading-[1] tracking-[-0.4px]">
          ...
          <button class="mt-9 rounded-2xl border-0 bg-pink-500 px-4 py-1 text-base font-semibold">
            Enroll Now
          </button>
        </section>
        <section class="absolute -bottom-20 right-0 flex h-24 w-24 items-center justify-center rounded-full border-4 border-pink-500 bg-white">
          <img src={tailwindLogo} class="h-12 w-12" />
        </section>
      </div>
    </header>
  );
